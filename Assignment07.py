...
class Person:
    '''
    A class representing person data object
    ...
    Thanit Mitparien, 08/10/2026, Created a class
    '''

    def __init__(self, first_name, last_name):
        '''
        This is a class constructor used to initialize a person object
        :param first_name:
        :param last_name:

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a constructor
        '''
    ...
    def first_name(self):
        ...
        ChangeLog (who, When, What)
        Thanit Mitparien, 08/10/2026, Created a getter function for a class property - "first_name: str"
        '''
    ...
    def first_name(self, value):
        '''
        This function sets the first name of the person class object

        :param value: first_name (str)
        :return: None

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a setter function for a class property - "first_name: str"
        '''
    ...
    def last_name(self):
        '''
        This function returns the last name of the person class object

        :return: last_name: str

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a getter function for a class property - "last_name: str"
        '''
    ...
    def last_name(self, value):
        '''
        This function sets the last name of the person class object

        :param value: last_name(str)
        :return: None

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a setter function for a class property - "last_name: str"
        '''
        if value.isalpha or value == "":
    ...
    def __str__(self):
        '''
        This function returns the string representation of the person class object

        :return: "first_name, last_name"

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a string dunder function for a Person class
        '''
...
class Student(Person):
    '''
     A class representing Student data object which is an inherited class from the Person class data object

    Properties:
        first_name (str): First name of the person
        last_name (str): Last name of the person
        course_name (str): Registered course name
    ...
    def __init__(self, first_name: str = '', last_name: str = '', course_name: str = ''):
        '''
        This constructor initializes Student class properties
        ...
        Thanit Mitparien, 08/10/2026, Created a constructor
        '''
        # Initialize first_name and last_name with Person Class Constructor
    ...
    def course_name(self):
        '''
        This getter functions return course_name property

        :return: Course_name (str)

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a getter function
        '''
    ...
    def course_name(self, value):
        '''
        This setter function sets the course_name property

        :param value: course_name (str)
        :return: None

        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a setter function
        '''
        if value.isalpha or value == "":
    ...
    def __str__(self):
        '''
        This function returns the string representation of the Student class object
        :return: "first_name,last_name,course_name"
        ChangeLog: (Who, When, What)
        Thanit Mitparien, 08/10/2026, Created a function
        '''
...
class FileProcessor:
    ...
    def write_data_to_file(file_name: str, student_data: list):
        """ This function writes data to a JSONfile with data from a list of dictionary rows
